...
void Enemy::drawA(sf::RenderWindow& window, float x, float y) const {
    ...
    sf::Color glow = (animFrame == 0) ? sf::Color(255, 255, 0) : sf::Color(255, 180, 0);
    for (int i = 0; i < 3; i++) {
...
void Enemy::draw(sf::RenderWindow& window) {
    ...
    switch (type_) {
        case EnemyType::A: drawA(window, x, y); break;
        case EnemyType::B: drawB(window, x, y); break;
        case EnemyType::C: drawC(window, x, y); break;
    }
}
